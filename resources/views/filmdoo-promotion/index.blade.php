    ...
    <div class="row mr-5" id="sortable">
      ...
      <div class="col-xl-2 col-md-3 col-sm-6 movie-card py-2 ui-state-default">
        <div class="card text-center h-100">
          <img class="card-img-top handle bg-dark" src="src="https://www.avvatta.com:8100/video_content/filmdoo/{{ $content->filmdoo_data->folder  }}/{{ $content->filmdoo_data->small_url  }}" alt="">
      ...
      $( "#movie_search" ).autocomplete({
        ...
        select: function (event, ui) {
          ...
          if(allowCard){
            ...
            movieCard +='<img class="card-img-top handle bg-dark" src="https://www.avvatta.com:8100/video_content/filmdoo/'+ui.item.folder+'/'+ui.item.small_url+'" alt="">';
