...
@section('content')
    <div class="container">
        <h6>Login Report @include('report-for-date-no-default')</h6><hr>
        ...
        <div class="table-responsive">
            <table id="loggedInUsersMonthly" class="table table-striped table-bordered dt-responsive nowrap" style="width:100%"> 
                ...
                <tbody>
                @foreach($loggedInUsersMonthly as $key => $data)
                    <tr>
                        <td>{{ $data->year }}</td>
                        <td>{{ $data->month }}</td>
                        <td>{{ $data->count }}</td>
        ...
        <div class="table-responsive">
            <table id="loggedInUsersDaily" class="table table-striped table-bordered dt-responsive nowrap" style="width:100%"> 
                ...
                <tbody>
                @foreach($loggedInUsersDaily as $key => $data)
                    <tr>
                        <td>{{ $data->date }}</td>
                        <td>{{ $data->count }}</td>
                    </tr>
