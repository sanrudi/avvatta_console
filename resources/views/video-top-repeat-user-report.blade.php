...
<div class="container">
  ...
  <div class="table-responsive">
    <table id="topRepeatedvideos" class="table table-striped table-bordered" style="width:100%">
      <thead>
        <tr>
          <th>Title</th>
          <th>Category</th>
...
<script>
  $(document).ready(function() {
    $('#topRepeatedvideos').DataTable( {
      dom: 'Bfrtip',
      info: false, pageLength: 10, "aaSorting": [],language: {search: "Search records here:"},
      buttons: [
      {
        extend: 'excel',
        text: 'Export Results',
