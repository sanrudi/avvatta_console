...
<div class="container">
  ...
  <hr>
  <div class="row mr-5">
    <div class="form-group col-xl-10 col-md-8"> 
      <label for="movie_search">Search & Add</label>
      <input type="text" class="form-control" id='movie_search' placeholder="Search & Add Erosnow Movies here...">
    </div>
    <div class="form-group col-xl-2 col-md-4">
      ...
      <form method="get" action="{{ route('cms-editor-erosnow.store') }}">
        <select name="category" id="category" class="form-control" onchange="this.form.submit()">
          ...
          <option value="Thriller" @if($category == "Thriller") selected="selected" @endif>Thriller</option>
        </select>
      </form>
    </div>
